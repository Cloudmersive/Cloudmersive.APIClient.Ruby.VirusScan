...
```shell
gem install ./cloudmersive-virus-scan-api-client-2.0.1.gem
```
(for development, run `gem install --dev ./cloudmersive-virus-scan-api-client-2.0.1.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cloudmersive-virus-scan-api-client', '~> 2.0.1'
